...
data generator for Vanilla [[GRU]]
    ...
    while True:
        ...
        if index == batch_size:
            ...
            for li in cur_batch:
                ...
                # [1, 1, 1, 0, 0, 0]
                example_mask = [1 if t else 0 for t in tensor_pad]
